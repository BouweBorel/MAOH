"""
Visualization file based on tutorial_02.py
---------------
...
#Personal comment:
#visualize boolean variable is used as the condition running simulation
#add_bodies boolean variable is used to add each body taken from 
...
# When a step is given to the plant, it becomes discrete,
# If it is set to 0.0, the plant is set as continuous
